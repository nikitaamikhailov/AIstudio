# Generated by Django 3.2.5 on 2021-07-10 02:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.report', verbose_name='Отчет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ready_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ready')),
            ],
        ),
    ]
